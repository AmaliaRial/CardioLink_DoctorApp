package bitalino;
    ...
    public enum BITalinoErrorTypes {
        ...
        public static final bitalino.BITalinoErrorTypes getType(int val)
        {
            for (bitalino.BITalinoErrorTypes t : bitalino.BITalinoErrorTypes.values())
            {
                if (t.getValue()==val)
                    return t;
            }
        ...
        public static final bitalino.BITalinoErrorTypes getType(String val)
        {
            for (bitalino.BITalinoErrorTypes t : bitalino.BITalinoErrorTypes.values())
            {
